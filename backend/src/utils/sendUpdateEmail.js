...
const sendOrderEmail = async (order) => {
    try {
        ...
        const templateParams = {
            ...
            order_status: " Your Order has been changed",
            order_message: "This email confirms that your order has been successfully updated as requested.",
        ...
        return { status: true, message: 'Order update sent successfully via EmailJS!', info: response };
