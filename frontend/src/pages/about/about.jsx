...
export default function About({ isUserLoged, setIsUserLoged }) {
  ...
  return (
    <div>
      ...
      {/* Testimonial Section */}
      <section className="testimonial" style={{ background: "#f3f2ee", padding: "80px 0" }}>
        <div className="container">
          <div className="row align-items-center">
            <div className="col-lg-6" style={{ paddingRight: "40px" }}>
              <div className="testimonial__text" style={{ padding: "40px 0" }}>
                ...
                <p style={{ fontStyle: "italic", fontSize: "18px", lineHeight: "30px", color: "#111" }}>
                ...
                <div className="testimonial__author" style={{ display: "flex", alignItems: "center", marginTop: "30px" }}>
                  ...
                  <div>
                    ...
                    <p style={{ marginBottom: 0, fontSize: "14px", color: "#888" }}>Fashion Design</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      {/* Counter Section */}
      <section className="counter spad" style={{ padding: "60px 0", borderBottom: "1px solid #e1e1e1" }}>
        <div className="container">
          <div className="row">
            {counterItems.map((item, idx) => (
              <div key={idx} className="col-lg-3 col-md-6 col-sm-6 text-center">
                <div className="counter__item" style={{ padding: "20px 0" }}>
                  <h2 style={{ fontSize: "48px", fontWeight: "700", color: "#111" }}>{item.value}</h2>
                  <span style={{ fontSize: "14px", color: "#888", textTransform: "uppercase", letterSpacing: "1px" }}>{item.label}</span>
                </div>
              </div>
            ))}
          </div>
